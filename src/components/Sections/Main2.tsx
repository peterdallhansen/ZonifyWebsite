    ...
    <section className="relative mb-20 flex h-screen w-screen flex-col overflow-hidden p-2 pb-0">
      <div className="min-h-0 w-full flex-1">
        <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-2xl bg-black">
          ...
          <div className="pointer-events-none absolute inset-0 rounded-2xl bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,0,0,0.2)_100%)]" />

          <div className="pointer-events-none absolute inset-0 rounded-2xl bg-gradient-to-t from-black/20 via-transparent to-black/40" />

          <div className="absolute bottom-12 left-2 z-10 flex max-w-3xl flex-col items-start justify-end space-y-6 px-0 text-left sm:bottom-16 sm:left-10 md:bottom-8 md:left-16">
            <BlurFade delay={0} inView>
              <h1 className="text-balance text-5xl leading-tight tracking-tight text-white sm:text-5xl xl:text-7xl">
